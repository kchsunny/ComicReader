...
################################################################################
## Form generated from reading UI file '左中展示区域_文件夹Item.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_dir_name = QLabel(self.widget)
        self.label_dir_name.setObjectName(u"label_dir_name")
        self.label_dir_name.setMinimumSize(QSize(0, 24))
        self.label_dir_name.setMaximumSize(QSize(16777215, 24))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_dir_name.setText(QCoreApplication.translate("Form", u"TextLabel", None))
